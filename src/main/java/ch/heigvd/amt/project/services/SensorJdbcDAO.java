...
public class SensorJdbcDAO implements SensorDAOLocal {
    ...
    public void create(Sensor s) {
        try {
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO sensors (id,description,type) VALUES("+s.getSensorID()+","+s.getDescription()+","+s.getType().toString()+");");
    ...
    public List<Sensor> findAll() {
        ...
        try {
            ...
            Sensor sensor;
            while (rs.next()) {
                sensor = new Sensor(rs.getLong("id"), rs.getString("description"), rs.getString("type"));
                result.add(sensor);
            }
